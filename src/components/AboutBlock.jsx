               ...
               >
                  ...
                  <div className="flex w-2/3 flex-col gap-4 self-center text-lg">
                     <p
                        ...
                        `)}
                     >
                        Graduated at the Polytechnic University of the
                        Philippines, I have been taught the important values of
                        perseverance, hard work, and determination. Towards my
                        dream as a software developer, I strive to build
                        impactful, efficient, and innovative software solutions
                        while continually learning, growing, and turning
                     ...
                     >
                        <button
                           className={ctl(`
                             cursor-pointer rounded-lg border-2 border-gray-800 bg-slate-950 px-4
                             py-2 transition duration-300 ease-out
